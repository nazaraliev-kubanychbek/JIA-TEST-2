...
export const Form = ({complate, setComplate}) => {
        ...
        <section className='contianer'>
            <div className={styles.container}>
                ...
                <form action="" className={styles.form}>
                    ...
                    <input style={!isLegalVisible ? {marginTop: '40px'} : {}} type="text" placeholder='Краткое описание деятельности вашей компании' />
                ...
                <div className={styles.buttonCont}>
                    <button onClick={() => setComplate(!complate)} className={styles.button}>Отправить</button>
                </div>
